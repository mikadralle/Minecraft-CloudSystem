package eu.unyfy.service;

import eu.unyfy.service.command.CommandHandler;
import eu.unyfy.service.logger.LoggingOutputStream;
import eu.unyfy.service.logger.ServiceLogger;
...
public abstract class Service {
  ...
  public Service() {
    ...
    logger = new ServiceLogger("cloud", consoleReader, "cloud", "log/");
